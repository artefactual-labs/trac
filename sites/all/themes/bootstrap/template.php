...
/**
 * TRAC Customizations
 * Overrides theme_form_elements()
 * Because http://drupal.org/node/314385 hasn't been implemented, giving UI control over description values
 */
function old_bootstrap_form_element($variables) {
  ...
  // We moved description to part of the prefix
  $prefix = isset($element['#description']) ? '<div class="description">' . $element['#description'] . "</div>\n" : '';
